...
<section class="static-page">
  <div class="static-page-inner">
    ...
    <p>本サイトは、障害福祉サービスの相談支援専門員としての実務経験を持つ運営者
    （{OPERATOR_NAME}）が、日々の相談支援業務の中で感じた「もっとこうなればいいのに」
    という思いから制作・運営しています。</p>
    ...
    <h2>お問い合わせ</h2>
    <p>本サイトの内容に関するお問い合わせ・ご指摘は、今後設置予定のお問い合わせ
    フォームよりご連絡ください。</p>
  </div>
</section>
"""
  ...
  <div class="static-page-inner">
    ...
    <ul>
      ...
      <li>耐用年数内であっても、身体状況の変化や破損等により、
        再支給が認められる場合があります。</li>
      <li>制度改定により、本サイトの情報が最新ではない場合があります。
        気づいた点がありましたらお問い合わせください。</li>
    </ul>
